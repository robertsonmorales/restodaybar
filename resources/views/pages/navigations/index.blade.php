        ...
        if (data.column[i].field == "status") {
            data.column[i].cellRenderer = function display(params) {
                if (params.data.status == "Active") {
                    return '<div class="badge badge-success p-2 font-size-sm">'+ params.data.status +'</div>';
                }else{
                    return '<div class="badge badge-secondary p-2 font-size-sm">'+ params.data.status +'</div>';
                }
            }
        }
