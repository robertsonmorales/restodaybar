...
$(document).ready(function(){
    ...
    columnDefs = {
        ...
        cellRenderer: function(params){
            var edit_url = '{{ route("menu_subcategories.edit", ":id") }}';
    ...
    $('#btn-import-submit').on('click', function(){
        ...
        document.getElementById("import-form-submit").action = "{{ route('menu_subcategories.import') }}";
    ...
    $('#btn-remove').on('click', function(){
        var destroy = '{{ route("menu_subcategories.destroy", ":id") }}';
