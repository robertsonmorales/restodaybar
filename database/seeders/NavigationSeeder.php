    ...
    public function run()
    {
        $navs = array(
            ...
            array(
                ...
                'sub' => array(
                    array('Menu Category', 'menu_categories', 'Maintenance\MenuCategory', 'circle', 'sub'),
                    array('Menu Subcategory', 'menu_subcategories', 'Maintenance\MenuSubcategory', 'circle', 'sub'),
                )
            )
        );
